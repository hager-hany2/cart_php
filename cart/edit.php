...
<nav class="navbar navbar-expand-lg " style="        background: #414140;">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" style="    color: white;font-weight:bold;" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                Dropdown
            </a>
        <ul class="dropdown-menu">
            ...
            <form class="form-inline my-2 my-lg-0" method="post" enctype="multipart/form-data" style="width:700px">
...
<div class="login"style=" position:relative;z-index:20;margin-top: 2%;"> 
    ...
    // left: 285px;
    // top: -81px;""class="bi bi-x-lg"onclick="this.parentElement.style.display="none";></i>
                
            
            
            }
            // else if(empty($$insert_query)){
            //      echo'<p class="alert alert-danger">product add not sucessfully</p>';
            // }
