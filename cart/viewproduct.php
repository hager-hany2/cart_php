...
<nav class="navbar navbar-expand-lg " style="        background: #414140;">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <ul class="dropdown-menu">
            ...
            <form class="form-inline my-2 my-lg-0" style="width:809px">
            ...
            <a href="" class="link-offset-2 link-underline link-underline-opacity-0 " style="margin-left: 18px;position: relative;top: 8px;    color: white;font-weight:bold;">view product</a>
