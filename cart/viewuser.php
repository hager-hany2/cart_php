...
<nav class="navbar navbar-expand-lg " style="        background: #414140;">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <ul class="dropdown-menu">
            ...
            <a href="#" class="link-offset-2 link-underline link-underline-opacity-0 text-light"style="    margin-left: 18px;position: relative;top: 8px;font-weight:bold;">view users</a>
